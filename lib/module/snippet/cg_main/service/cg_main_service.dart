...
//Buatlah List<Map> uiMenuList di Flutter yang berisi Map dengan label, icon,color dan event onPressed tanpa isi. Tambahkan 3 data di dalamnya berupa Dashboard, ListView, DetailView, ReportView, ProfileView dengan color yang unik dan gunakan MdiIcons.
  List<Map> slicingUiMenuList = [
    ...
    },
    {
      ...
      'icon': MdiIcons.loginVariant,
      'color': Colors.grey,
      'page': UkDashboard1View(),
    },
    {
      'label': 'EDashboard2',
      'icon': MdiIcons.loginVariant,
      'color': Colors.grey,
      'page': UkDashboard2View(),
    },
    {
      'label': 'EDashboard3',
      'icon': MdiIcons.loginVariant,
      'color': Colors.grey,
      'page': UkDashboard3View(),
    },
    {
      'label': 'EDashboard4',
      'icon': MdiIcons.loginVariant,
      'color': Colors.grey,
      'page': UkDashboard4View(),
    },
    {
      'label': 'EDashboard5',
      'icon': MdiIcons.loginVariant,
      'color': Colors.grey,
      'page': UkDashboard5View(),
    },
    {
      'label': 'EDashboard6',
      'icon': MdiIcons.loginVariant,
      'color': Colors.grey,
      'page': UkDashboard6View(),
    },
    {
      'label': 'EDashboard7',
      'icon': MdiIcons.loginVariant,
      'color': Colors.grey,
      'page': UkDashboard7View(),
    },
    {
      'label': 'EDashboard8',
      'icon': MdiIcons.loginVariant,
      'color': Colors.grey,
      'page': UkDashboard8View(),
    },
    {
      'label': 'EDashboard9',
      'icon': MdiIcons.loginVariant,
      'color': Colors.grey,
      'page': UkDashboard9View(),
    },
    {
      'label': 'EDashboard10',
      'icon': MdiIcons.loginVariant,
      'color': Colors.grey,
      'page': UkDashboard10View(),
    },
    {
      'label': 'EList1',
      'icon': MdiIcons.loginVariant,
